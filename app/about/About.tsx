    ...
    <div className={`${theme === "dark" ? "text-white" : "text-black"}`}>
      ...
      <div className="w-[95%] md:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than ShariCode, the premier programming community dedicated
          to helping new programmers achieve their goals and reach their full
          potential.
          <br />
          <br />
          As the founder and CEO of ShariCode, I know firsthand the challenges
          that come with learning and growing in the programming industry.
          That&apos;s why I created ShariCode &ndash; to provide new programmers
          ...
          <br />
          <br />
          At ShariCode, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But ShariCode is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With ShariCode by your side, there&apos;s nothing standing between you
          ...
          <br />
          <br />
          So what are you waiting for? Join the ShariCode family today and
        ...
        <br />
        <span className="font-sans text-[22px]">Mehar Safian&apos;s</span>
        <h5 className="text-[18px] font-Poppins">
          Founder and CEO of ShariCode
        </h5>
        <br />
        <br />
        <br />
