  ...
  useEffect(() => {
    ...
    if (error) {
      if ("data" in error) {
        ...
        console.log("An error ossured!", error);
      }
    }
  }, [isSuccess, error]);
  ...
  return (
    <div>
      ...
      <div className="w-full flex items-center justify-center mt-2">
        <div className="w-[80px] h-[80px] rounded-full bg-[#297DF2] flex items-center justify-center">
          <VscWorkspaceTrusted
            size={40}
      ...
      <div className="w-full flex justify-center">
        <button className={`${styles.button}`}>Verify OTP</button>
      </div>
