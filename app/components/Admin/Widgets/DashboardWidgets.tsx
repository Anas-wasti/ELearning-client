      ...
      if (data && ordersData) {
        ...
        if (
          ...
          setUserComparePercentenge({
            ...
            percentChange: usersPerecentChange,
          });
    ...
    <div className="mt-[30px] min-h-screen">
      <div className="grid grid-cols-[75%,25%]">
        ...
        <div className="pt-[80px] pr-8">
          <div
            className={`w-full ${
              theme === "dark" ? "bg-[#111C43]" : "bg-[#ffffffcb]"
            } rounded-sm shadow`}
          >
            <div className="flex items-center p-5 justify-between">
              <div className="">
                <BiBorderLeft
                  className={`${
                    theme === "dark" ? "text-[#45CBA0]" : "text-black"
                  } text-[30px]`}
                />
                <h5
      ...
      <div className="grid grid-cols-[65%,35%] mt-[-20px]">
        <div
          className={`${
            theme === "dark" ? "bg-[#111C43]" : "bg-[#ffffffcb]"
          } w-[94%] mt-[30px] h-[40vh] shadow-sm m-auto`}
        >
        ...
        <div className="p-5">
          <h5
            className={` ${
              theme === "dark" ? "text-[#fff]" : "text-[#000]"
            }text-[20px] font-[400] font-Poppins pb-3 `}
          >
            Recent Transactions
          </h5>
