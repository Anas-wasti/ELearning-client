...
const AllUsers: FC<Props> = ({ isTeam }) => {
  ...
  useEffect(() => {
    if (deleteSuccess) {
      refetch();
      toast.success("User deleted successfull!y");
      setOpen(false);
    }
    if (isSuccess) {
      refetch();
          ...
          <Box
            ...
            sx={{
              ...
              "& .MuiDataGrid-row.Mui-selected": {
                backgroundColor: theme === "dark" ? "#2c3e50" : "#c5cae9",
              },
              "& .MuiDataGrid-row.Mui-selected:hover": {
                backgroundColor: theme === "dark" ? "#34495e" : "#9fa8da",
              },
              ...
              "& .MuiDataGrid-row:hover": {
                backgroundColor: theme === "dark" ? "#2a3355" : "#e0e0e0",
              },
